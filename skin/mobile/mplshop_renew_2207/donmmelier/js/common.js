$(document).ready(function() {
    ...
    $(document).on('click', '.close_btn, .confirm_btn', function(){
        $(this).parents('.s11_guide_modal').css('display', 'none');
...
function initEvent() {
    // 메뉴 open
    $('#btn-navi-menu-close').on('click', function() {
        $('#main-menu-wrap').removeClass('gnb_open');
    });

    // 메뉴 close
    $('#btn-navi-menu-open').on('click', function() {
        $('#main-menu-wrap').addClass('gnb_open');
    });
...
function displayElement(elementId){
    ...
    if($element.hasClass('modal_wrap')){
